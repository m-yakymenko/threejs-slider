...
export const CanvasS = () => {
  return (
    <Canvas shadows={{ type: THREE.BasicShadowMap }} style={{ width: '100%', height: '100%' }}>
      <OrbitControls />
      {/*<ambientLight position={[0, 0, 9]} intensity={Math.PI / 2} />*/}
      <spotLight position={[0, 0, 9]} angle={0.45} penumbra={1} decay={0} intensity={Math.PI} castShadow distance={10} />
